						...
						<div class="row justify-content-center">
							<div class="col-md-8 col-xl-6 col-sm-7 col-12 green border-2 p-5">
								<form method="POST" class="d-flex flex-column gap-3">
									...
									<div class="d-flex gap-3"><img src="res/iaccount.svg" class="sizeIcon"><input name="id" type="text" placeholder="Identifiant" class="border-0 border-1 w-75 ps-2 pt-2 pb-2"></div>
