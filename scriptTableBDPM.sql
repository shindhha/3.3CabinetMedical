...
ALTER TABLE DesignationElemPharma ADD CONSTRAINT PK_DesignationElemPharma PRIMARY KEY (idDesignation);
...
CREATE TABLE CIS_CIP_BDPM (
    ...
    codeCIP7 INT(7),
    idLibellePresentation INT(3),
    statutAdminiPreesentation BOOL,
    idEtatCommercialisation INT(1),
...
ALTER TABLE CIS_CIP_BDPM ADD CONSTRAINT PK_CIS_CIP PRIMARY KEY (codeCIS);
...
/* -------------------------------------------- Creation de la table DenomSubstance -------------------------------------------- */
CREATE TABLE DenomSubstance (
    idDenom INT(3),
    labelSubstance VARCHAR(100)
);
ALTER TABLE DenomSubstance ADD CONSTRAINT PK_DenomSubstance PRIMARY KEY (idDenom);
...
ALTER TABLE CIS_COMPO ADD CONSTRAINT FK_CIS_COMPO_DenomSubstance FOREIGN KEY (idDenomSubstance) REFERENCES DenomSubstance(idDenom);
ALTER TABLE CIS_COMPO ADD CONSTRAINT FK_CIS_COMPO_RefDosage FOREIGN KEY (idRefDsage) REFERENCES RefDosage(idRefDosage);
...
ALTER TABLE LibelleSmr ADD CONSTRAINT PK_LibelleSmr PRIMARY KEY (idSMR);
...
ALTER TABLE CIS_HAS_SMR ADD CONSTRAINT PK_CIS_HAS_SMR PRIMARY KEY (codeCIS);
...
ALTER TABLE CIS_HAS_SMR ADD CONSTRAINT FK_CIS_HAS_SMR_LibelleSmr FOREIGN KEY (idLibelleSmr) REFERENCES LibelleSmr(idSMR);
